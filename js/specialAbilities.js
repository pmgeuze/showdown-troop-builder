var SPECIAL_ABILITIES = [
    ...
    {name: 'Semi-Aquatic', cost: 5, desc: 'The figure ignores water-based Difficult Terrain; in deep water it moves at its listed Aquatic Pace'},
    {name: 'Sensors', cost: 3, desc: 'The model ignores penalties for Dim and Dark lighting'},
    {name: 'Shark man Skin', cost: 10, desc: ' Shark man skin is made of a matrix of hard, tooth-like structures called placoid scales that add +2 to their Toughness.', affectedStat: 'toughness', affectValue: 2},
